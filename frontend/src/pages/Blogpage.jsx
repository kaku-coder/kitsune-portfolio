...
4. Error Lens — See errors without hovering
    ...
    },
    {
      ...
      prefix: 'DevOps',
      subtitle: 'Containerization & Multi-Stage Builds',
      description:
        'Speed up your workflow and ship faster with these essential Docker practices. Reduce image sizes by up to 80%.',
      category: 'DevOps',
      readTime: '5 min read',
      date: 'Coming Soon',
      featured: false,
    ...
    },
    {
      ...
      prefix: 'Frontend',
      subtitle: 'ScrollTrigger & Smooth Canvas Motion',
      description:
        'Bring your web apps to life with smooth, performant animations using GSAP and Framer Motion without dropping frame rates.',
      category: 'Frontend',
      readTime: '8 min read',
      date: 'Coming Soon',
      featured: false,
    ...
    },
    {
      ...
      prefix: 'Backend',
      subtitle: 'Database Performance & Compound Indexes',
      description:
        'Understand indexing like a pro and supercharge your database queries with compound indexes and aggregation pipelines.',
      category: 'Backend',
      readTime: '6 min read',
      date: 'Coming Soon',
      featured: false,
    ...
    },
    {
      ...
      prefix: 'Career',
      subtitle: 'Self-Taught Lessons & Growth',
      description:
        'Lessons, failures, and wins from my journey as a self-taught full stack developer building real-world projects.',
      category: 'Career',
      readTime: '7 min read',
      date: 'Coming Soon',
      featured: false,
      image: cardimage1summer,
      comingSoon: true,
      content: '',
    },
  ];
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs opacity-60">• {selectedArticle.readTime}</span>
              </div>
